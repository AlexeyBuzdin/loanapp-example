...
public class ClientLoanRestControllerTest extends BaseRestTest {
    ...
    private ExtractableResponse takeALoan(long term, long amount, String location, HttpStatus status) {
        return given().
          body(TestBuilder.forBean(IssueLoanModel::new).
